...
static bool_t		clntraw_control(CLIENT *, u_int, caddr_t);
...
static void
clntraw_geterr(CLIENT *, struct rpc_err *)
{
}
...
static void
clntraw_abort(CLIENT *)
{
}

static bool_t
clntraw_control(CLIENT *, u_int, caddr_t)
{
	return (FALSE);
}

static void
clntraw_destroy(CLIENT *)
{
}
